                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $data['category'] ?></td>
                                        <td>
                                            <img src="images/<?= $data['thumbnail'] ?>" class="img-fluid imgthumbnail">
                                        </td>
                                        <td>
                                            <div class="btn-group">
                                                <a href="edit.php?id=<?= $data['id'] ?>" class="btn btnwarning">Edit</a>
                                                <a href="delete.php?id=<?= $data['id'] ?>" class="btn btndanger">Delete</a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php
